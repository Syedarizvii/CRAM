  ...
  axios({
    ...
    .then(response => {
      ...
      if (response.status === 201) {
        window.location = "https://e-crime-system-acc.herokuapp.com/e-crime-system-acc.herokuapp.com/reportsuccessfull";
                ...
                <MDBCard className="report-card">
                  <MDBCardBody className="mx-4">
                    ...
                    <label className="font-color font-weight-bold">
                      Reported By: <br/>(Enter Your Full Name as per Your Profile)
                  </label>
