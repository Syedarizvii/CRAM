...
function Report() {
  ...
  return (
    <div>
      ...
      <main id="content">
        <Routes />
        <MDBContainer className="d-flex justify-content-center Signin-Container pt-5 pb-5">
          <MDBRow>
            <MDBCol>
              <form>
                <MDBCard className="report-card">
                  <MDBCardBody className="mx-4">
                    <div className="text-center">
                      <h3 className="signup-signin-heading">Report a Crime</h3>
                    ...
                    <label className="font-color font-weight-bold">
                      Reported By: <br />
                      (Enter Your Full Name as per Your Profile)
                    </label>
                    <input
                    ...
                    <input
                      ...
                      value={Ocurence_Date}
                      onChange={(e) => {
                        setOcurence_Date(e.target.value);
                      }}
                    />
                    <br />
                    <label className="font-color font-weight-bold">
                    ...
                    <input
                      ...
                      value={Reported_Date}
                      onChange={(e) => {
                        setReported_Date(e.target.value);
                      }}
                    />
                    <br />
                    <label className="font-color font-weight-bold">
                    ...
                    <br />
                    <input
                      className="btn-block z-depth-1a white-text blue-gradient-for-report waves-effect waves-light hoverable SigninButton"
                      type="button"
                      value="Report"
